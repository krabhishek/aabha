/**
 * WitnessFixturesValidation Rule
...
export const witnessFixturesValidation = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/witness/witness-fixtures-validation.ts
