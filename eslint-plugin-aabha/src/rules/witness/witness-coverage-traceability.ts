/**
 * WitnessCoverageTraceability Rule
...
export const witnessCoverageTraceability = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/witness/witness-coverage-traceability.ts
