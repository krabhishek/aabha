/**
 * WitnessFixtureMethodExists Rule
...
export const witnessFixtureMethodExists = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/witness/witness-fixture-method-exists.ts
