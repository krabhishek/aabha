/**
 * WitnessPriorityRiskAlignment Rule
...
export const witnessPriorityRiskAlignment = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/witness/witness-priority-risk-alignment.ts
