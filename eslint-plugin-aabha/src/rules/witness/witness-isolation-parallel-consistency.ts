/**
 * WitnessIsolationParallelConsistency Rule
...
export const witnessIsolationParallelConsistency = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/witness/witness-isolation-parallel-consistency.ts
