/**
 * WitnessExecutionConsistency Rule
...
export const witnessExecutionConsistency = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/witness/witness-execution-consistency.ts
