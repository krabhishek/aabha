...
export const metricThresholdOrdering = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/metric/metric-threshold-ordering-rule.ts
