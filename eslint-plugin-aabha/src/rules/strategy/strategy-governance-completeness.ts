/**
 * StrategyGovernanceCompleteness Rule
...
export const strategyGovernanceCompleteness = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/strategy/strategy-governance-completeness-rule.ts
