...
export const strategyP2wCompleteness = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/strategy/strategy-p2w-completeness-rule.ts
