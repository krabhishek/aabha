...
export const strategyMetricsRequired = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/strategy/strategy-metrics-required-rule.ts
