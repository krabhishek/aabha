/**
 * StakeholderMetricsTracking Rule
...
export const stakeholderMetricsTracking = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/stakeholder/stakeholder-metrics-tracking-rule.ts
