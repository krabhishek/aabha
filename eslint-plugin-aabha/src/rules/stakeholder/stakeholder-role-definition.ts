/**
 * StakeholderRoleDefinition Rule
...
export const stakeholderRoleDefinition = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/stakeholder/stakeholder-role-definition-rule.ts
