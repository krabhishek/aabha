/**
 * StakeholderInfluenceConsistency Rule
...
export const stakeholderInfluenceConsistency = createRule({
  ...
  create(context) {
    return {
      ClassDeclaration(node: TSESTree.ClassDeclaration) {
        ...
        // Reference: packages/aabha-plugin-core-rules/src/rules/stakeholder/stakeholder-influence-consistency-rule.ts
